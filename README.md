...
Aplicação web unificada para o **El Dourado by Sapore** que reúne, em um único lugar, as duas ferramentas internas de controle de estoque e qualidade, com histórico de gerações e funcionamento offline.
...
- **3 abas** acessíveis no topo:
  - **Parâmetros de Compras** — lista dinâmica de produtos (nome, quantidade atual, comprar) → gera PDF retrato A4
  - **RNC** — formulário completo de Relatório de Não Conformidade com até 2 imagens → gera PDF paisagem A4
  - **Histórico** — lista de todos os PDFs gerados, com data/hora e os itens preenchidos
...
- **Tipo** (Parâmetros ou RNC)
- **Título** descritivo (ex.: "RNC Nº 02 — Queijo Mussarela" ou "Parâmetros — 12 itens (13/05/2026)")
- **Data e hora da geração**
- **Todos os itens preenchidos** (campos textuais — imagens do RNC não são salvas no histórico para economizar espaço)
...
- **[html2canvas](https://html2canvas.hertzen.com/) 1.4.1** + **jsPDF** — PDF da aba RNC (a partir de um template HTML oculto)
